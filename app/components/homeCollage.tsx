      ...
      <div className="relative w-screen h-[800px]">
        ...
        <div className = "absolute top-[55%] left-[-4%] group">
          <Image
            ...
            width={350}
            height={200}
            className="rounded-xl shadow-2xl transition-transform duration-300 ease-out hover:scale-110 hover:-translate-y-2 hover:shadow-3xl group-hover:rotate-2"
          />
        </div>
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -translate-y-[70%] z-20 group">
          <Image
            src="/aboutMe1.png"
            alt="picture of me (main)"
            width={430} 
            height={480}
            className="rounded-[40px] shadow-2xl transition-transform duration-300 ease-out hover:scale-110 hover:-translate-y-2 hover:shadow-3xl group-hover:rotate-2"
          />
        </div>
        ...
        <div className="absolute top-[17%] left-[15%] z-10 group">
          <Image
            ...
            width={270}
            height={200}
            className="rounded-2xl transition-transform duration-300 ease-out hover:scale-110 hover:-translate-y-2 hover:shadow-3xl group-hover:rotate-2"
          />
        </div>
